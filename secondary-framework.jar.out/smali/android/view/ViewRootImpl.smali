...
.method static synthetic access$2500(Landroid/view/ViewRootImpl;)V
    .locals 0
    .parameter "x0"
...
.method static synthetic access$2600(Landroid/view/ViewRootImpl;II)V
    .locals 0
    .parameter "x0"
    .parameter "x1"
    .parameter "x2"
...
.method private setSmartRoll(ZZII)I
    ...
    :cond_1
    iget-boolean v6, p0, Landroid/view/ViewRootImpl;->mIsSmartRolled:Z
    ...
    iget-boolean v6, p0, Landroid/view/ViewRootImpl;->mIsOrientationAllowRoll:Z

    if-nez v6, :cond_3

    const-string v3, "SmartRoll/ViewRootImpl"

    const-string v4, "setSmartRoll: mIsOrientationAllowRoll is false, ignore"
    ...
    :cond_4
    const-string v6, "SmartRoll/ViewRootImpl"

    const-string v7, "setSmartRoll: mHardwareRenderer is null, ignore"
    ...
    invoke-virtual {v6, v4}, Landroid/view/View;->dispatchClickable(Z)Z

    :cond_6
    if-nez p2, :cond_8

    iput-boolean p1, p0, Landroid/view/ViewRootImpl;->mIsSmartRolled:Z

    iget-object v5, p0, Landroid/view/ViewRootImpl;->mView:Landroid/view/View;

    invoke-virtual {v5, p1, v4}, Landroid/view/View;->dispatchSmartRoll(ZZ)Z
    ...
    const-string v5, "SmartRoll/ViewRootImpl"

    const-string v6, "setSmartRoll: dispatchSmartRoll return false"
    ...
    invoke-virtual {v6, p1, p3, p4}, Landroid/view/View;->allocSmartRollAnimation(ZII)Z
    ...
    const-string v4, "setSmartRoll: allocSmartRollAnimation fail, ignore"
    ...
    invoke-virtual {v5, p1, v3}, Landroid/view/View;->dispatchSmartRoll(ZZ)Z
    ...
    iget-object v5, v5, Landroid/view/View;->mSmartRollAnimation:Lcom/lenovo/SmartRoll/SmartRollAnimation;

    invoke-virtual {v5, v0}, Lcom/lenovo/SmartRoll/SmartRollAnimation;->onResultSupportAndChanged(Ljava/lang/Runnable;)V
    ...
    .local v2, showNotChangedAnimation:Z
    iget-object v5, p0, Landroid/view/ViewRootImpl;->mView:Landroid/view/View;

    invoke-virtual {v5}, Landroid/view/View;->releaseSmartRollAnimation()Z

    iget-object v5, p0, Landroid/view/ViewRootImpl;->mView:Landroid/view/View;

    iget-boolean v5, v5, Landroid/view/View;->mHasSurfaceView:Z

    if-eqz v5, :cond_a

    const-string v5, "SmartRoll/ViewRootImpl"

    const-string v6, "setSmartRoll: mView.mHasSurfaceView, don\'t show toast"
...
.method public onHardwarePreDraw(Landroid/view/HardwareCanvas;)V
    ...
    iget v4, p0, Landroid/view/ViewRootImpl;->mHardwareYOffset:I

    neg-int v4, v4

    int-to-float v4, v4

    invoke-virtual {p1, v3, v4}, Landroid/view/HardwareCanvas;->translate(FF)V
    ...
    iget-object v3, v3, Landroid/view/View;->mSmartRollAnimation:Lcom/lenovo/SmartRoll/SmartRollAnimation;
    ...
    .local v2, shadow:Landroid/graphics/drawable/ColorDrawable;
    invoke-virtual {p1}, Landroid/view/HardwareCanvas;->isOpaque()Z
    ...
    invoke-virtual {v3}, Lcom/lenovo/SmartRoll/SmartRollAnimation;->getAnimationAlpha()I

    move-result v3

    invoke-virtual {v2, v3}, Landroid/graphics/drawable/ColorDrawable;->setAlpha(I)V

    invoke-virtual {p1}, Landroid/view/HardwareCanvas;->getClipBounds()Landroid/graphics/Rect;
    ...
    .end local v1           #o:Z
    .end local v2           #shadow:Landroid/graphics/drawable/ColorDrawable;
    :cond_1
    return-void
.end method
...
.method public setView(Landroid/view/View;Landroid/view/WindowManager$LayoutParams;Landroid/view/View;)V
    ...
    iput v2, v0, Landroid/view/ViewRootImpl;->mViewLayoutDirectionInitial:I

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mFallbackEventHandler:Landroid/view/FallbackEventHandler;
    ...
    iput v2, v0, Landroid/view/ViewRootImpl;->mClientWindowLayoutFlags:I
    ...
    invoke-virtual {v0, v2, v3}, Landroid/view/ViewRootImpl;->setAccessibilityFocus(Landroid/view/View;Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    :cond_0
    invoke-static/range {v17 .. v17}, Lcom/lenovo/SmartRoll/SmartRollFilter;->isRootViewPackageFilterOut(Ljava/lang/String;)Z
    ...
    iput-boolean v3, v2, Landroid/view/View;->mIsSupportSmartRoll:Z

    const-string v2, "SmartRoll/ViewRootImpl"

    const-string v3, "setView: package is filter out"
    ...
    instance-of v2, v0, Lcom/android/internal/view/RootViewSurfaceTaker;
    ...
    invoke-interface {v2}, Lcom/android/internal/view/RootViewSurfaceTaker;->willYouTakeTheSurface()Landroid/view/SurfaceHolder$Callback2;

    move-result-object v2

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/view/ViewRootImpl;->mSurfaceHolderCallback:Landroid/view/SurfaceHolder$Callback2;

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mSurfaceHolderCallback:Landroid/view/SurfaceHolder$Callback2;

    if-eqz v2, :cond_2

    new-instance v2, Landroid/view/ViewRootImpl$TakenSurfaceHolder;

    move-object/from16 v0, p0

    invoke-direct {v2, v0}, Landroid/view/ViewRootImpl$TakenSurfaceHolder;-><init>(Landroid/view/ViewRootImpl;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/view/ViewRootImpl;->mSurfaceHolder:Lcom/android/internal/view/BaseSurfaceHolder;
    ...
    invoke-virtual {v2, v3}, Lcom/android/internal/view/BaseSurfaceHolder;->setFormat(I)V

    :cond_2
    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mCompatibilityInfo:Landroid/view/CompatibilityInfoHolder;
    ...
    iput-object v2, v0, Landroid/view/ViewRootImpl;->mTranslator:Landroid/content/res/CompatibilityInfo$Translator;
    ...
    invoke-direct {v0, v2, v1}, Landroid/view/ViewRootImpl;->enableHardwareAcceleration(Landroid/content/Context;Landroid/view/WindowManager$LayoutParams;)V
    ...
    sget-boolean v2, Landroid/view/ViewRootImpl;->DEBUG_LIFECYCLE:Z
    ...
    const-string v4, "WindowLayout in setView:"
    ...
    const-string v4, ",compatibilityInfo = "
    ...
    iput-boolean v2, v0, Landroid/view/ViewRootImpl;->mLastInCompatMode:Z
    ...
    iput v2, v0, Landroid/view/ViewRootImpl;->mSoftInputMode:I

    const/4 v2, 0x1

    move-object/from16 v0, p0

    iput-boolean v2, v0, Landroid/view/ViewRootImpl;->mWindowAttributesChanged:Z

    const/4 v2, -0x1

    move-object/from16 v0, p0

    iput v2, v0, Landroid/view/ViewRootImpl;->mWindowAttributesChangesFlag:I
    ...
    iput-object v0, v2, Landroid/view/View$AttachInfo;->mRootView:Landroid/view/View;
    ...
    :goto_1
    iput-boolean v2, v3, Landroid/view/View$AttachInfo;->mScalingRequired:Z
    ...
    :goto_2
    iput v2, v3, Landroid/view/View$AttachInfo;->mApplicationScale:F
    ...
    iput-object v3, v2, Landroid/view/View$AttachInfo;->mPanelParentWindowToken:Landroid/os/IBinder;
    ...
    iput-boolean v2, v0, Landroid/view/ViewRootImpl;->mAdded:Z
    ...
    iput-object v2, v0, Landroid/view/ViewRootImpl;->mInputChannel:Landroid/view/InputChannel;

    :cond_9
    move-object/from16 v0, p0

    invoke-virtual {v0}, Landroid/view/ViewRootImpl;->createInputChannelAnyWay()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput v2, v0, Landroid/view/ViewRootImpl;->mOrigWindowType:I
    ...
    iget-object v7, v0, Landroid/view/ViewRootImpl;->mDisplay:Landroid/view/Display;
    ...
    iget-object v8, v8, Landroid/view/View$AttachInfo;->mContentInsets:Landroid/graphics/Rect;

    move-object/from16 v0, p0

    iget-object v9, v0, Landroid/view/ViewRootImpl;->mInputChannel:Landroid/view/InputChannel;
    ...
    const-string v4, ", mPendingContentInsets = "
    ...
    iput-object v3, v2, Landroid/view/View$AttachInfo;->mRootView:Landroid/view/View;
    ...
    invoke-interface {v2, v3}, Landroid/view/FallbackEventHandler;->setView(Landroid/view/View;)V
    ...
    const-string v4, "Unable to add window -- unknown error code "
    ...
    :cond_d
    :try_start_3
    invoke-static {v11}, Lcom/lenovo/SmartRoll/SmartRollFilter;->isRootViewActivityFilterOut(Ljava/lang/String;)Z
    ...
    const-string v3, "setView: activity is filter out"
    ...
    :cond_e
    invoke-static {}, Lcom/lenovo/SmartRoll/SmartRollFilter;->isNonPreinstallPackageFilterOut()Z
    ...
    iput-object v2, v0, Landroid/view/ViewRootImpl;->mView:Landroid/view/View;
    ...
    const-string v4, " is not valid; is your activity running?"
    ...
    invoke-direct {v2, v3}, Landroid/view/WindowManager$BadTokenException;-><init>(Ljava/lang/String;)V
    ...
    const-string v4, " is not for an application"
    ...
    const-string v4, "Unable to add window -- window "
    ...
    const-string v4, " has already been added"
    ...
    const-string v4, "Unable to add window "
    ...
    const-string v4, " -- another window of this type already exists"
    ...
    const-string v4, " -- permission denied for this window type"
    ...
    const-string v4, " -- the specified display can not be found"
    ...
    const-string v4, " -- input channel is not allowed"
    ...
    invoke-interface {v2}, Lcom/android/internal/view/RootViewSurfaceTaker;->willYouTakeTheInputQueue()Landroid/view/InputQueue$Callback;

    move-result-object v2

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/view/ViewRootImpl;->mInputQueueCallback:Landroid/view/InputQueue$Callback;

    :cond_13
    move-object/from16 v0, p0

    invoke-virtual {v0}, Landroid/view/ViewRootImpl;->discardInputChannelBySetting()V

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mInputChannel:Landroid/view/InputChannel;

    if-eqz v2, :cond_14

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mInputQueueCallback:Landroid/view/InputQueue$Callback;

    if-eqz v2, :cond_17

    new-instance v2, Landroid/view/InputQueue;

    move-object/from16 v0, p0

    iget-object v3, v0, Landroid/view/ViewRootImpl;->mInputChannel:Landroid/view/InputChannel;

    invoke-direct {v2, v3}, Landroid/view/InputQueue;-><init>(Landroid/view/InputChannel;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/view/ViewRootImpl;->mInputQueue:Landroid/view/InputQueue;
    ...
    iget-object v3, v0, Landroid/view/ViewRootImpl;->mInputQueue:Landroid/view/InputQueue;

    invoke-interface {v2, v3}, Landroid/view/InputQueue$Callback;->onInputQueueCreated(Landroid/view/InputQueue;)V
    ...
    iput-boolean v2, v0, Landroid/view/ViewRootImpl;->mAddedTouchMode:Z
    ...
    iput-boolean v2, v0, Landroid/view/ViewRootImpl;->mAppVisible:Z

    move-object/from16 v0, p0

    iget-object v2, v0, Landroid/view/ViewRootImpl;->mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;
    ...
    iget-object v2, v0, Landroid/view/ViewRootImpl;->mAccessibilityInteractionConnectionManager:Landroid/view/ViewRootImpl$AccessibilityInteractionConnectionManager;

    invoke-virtual {v2}, Landroid/view/ViewRootImpl$AccessibilityInteractionConnectionManager;->ensureConnection()V
    ...
    .restart local v19       #restore:Z
    :cond_17
    new-instance v2, Landroid/view/ViewRootImpl$WindowInputEventReceiver;
    ...
    invoke-direct {v2, v0, v3, v4}, Landroid/view/ViewRootImpl$WindowInputEventReceiver;-><init>(Landroid/view/ViewRootImpl;Landroid/view/InputChannel;Landroid/os/Looper;)V

    move-object/from16 v0, p0

    iput-object v2, v0, Landroid/view/ViewRootImpl;->mInputEventReceiver:Landroid/view/ViewRootImpl$WindowInputEventReceiver;
    :try_end_5
    .catchall {:try_start_5 .. :try_end_5} :catchall_0
...
.method updateConfiguration(Landroid/content/res/Configuration;Z)V
    ...
    :cond_6
    invoke-direct {p0, v8}, Landroid/view/ViewRootImpl;->setSmartRoll(Z)I

    iput-boolean v8, p0, Landroid/view/ViewRootImpl;->mIsOrientationAllowRoll:Z
