...
.method private getChargeInfo(Llibcore/util/MutableInt;)Ljava/lang/CharSequence;
    ...
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mShowingBatteryInfo:Z
    ...
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mPluggedIn:Z
    ...
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mBatteryCharged:Z
    ...
    iget v6, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mBatteryLevel:I
    ...
    iget-object v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mContext:Landroid/content/Context;

    const-string v4, "ic_lock_idle_charging"

    const-string v5, "drawable"

    invoke-static {v2, v4, v5, v3}, Lcom/android/internal/widget/LockPatternUtils;->getContextResId(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;I)I
    ...
    .end local v0           #id:I
    :goto_1
    iput v0, p1, Llibcore/util/MutableInt;->value:I
    ...
    .end local v0           #id:I
    :cond_3
    iget-boolean v2, p0, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->mBatteryIsLow:Z
    ...
    const-string v4, "ic_lock_idle_low_battery"
...
.method update()V
    ...
    .local v0, chargeInfo:Ljava/lang/CharSequence;
    const/4 v4, 0x3
    ...
    invoke-virtual {p0, v7, v4, v7, v7}, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->setCompoundDrawablesWithIntrinsicBounds(IIII)V
    ...
    invoke-virtual {v4}, Lcom/android/internal/policy/impl/keyguard/KeyguardUpdateMonitor;->dmIsLocked()Z
    ...
    :cond_1
    invoke-direct {p0, v3}, Lcom/android/internal/policy/impl/keyguard/KeyguardMessageArea;->setTextMediatek(Ljava/lang/CharSequence;)V
