...
.method private getRemoteContext(Landroid/widget/RemoteViews;)Landroid/content/Context;
    ...
    invoke-virtual {v4, v2, v5}, Landroid/content/Context;->createPackageContext(Ljava/lang/String;I)Landroid/content/Context;

    move-result-object v3

    .local v3, remoteContext:Landroid/content/Context;
    invoke-static {v2}, Lcom/lenovo/SmartRoll/SmartRollFilter;->isWidgetViewPackageFilterOut(Ljava/lang/String;)Z
    ...
    iput-boolean v4, p0, Landroid/appwidget/AppWidgetHostView;->mIsSupportSmartRoll:Z
    :try_end_0
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_0 .. :try_end_0} :catch_0

    goto :goto_0

    .end local v3           #remoteContext:Landroid/content/Context;
    :catch_0
    move-exception v1
    ...
    .restart local v3       #remoteContext:Landroid/content/Context;
    :cond_2
    :try_start_1
    invoke-static {}, Lcom/lenovo/SmartRoll/SmartRollFilter;->isNonPreinstallWidgetPackageFilterOut()Z
